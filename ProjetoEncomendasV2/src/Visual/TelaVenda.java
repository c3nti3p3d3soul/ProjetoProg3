...
public class TelaVenda extends JFrame {
	...
	private Usuario usuarioLogado; // Adicione um campo para o usuário

	
	
	public void exibirInformacoesUsuario(Usuario usuario) {
		usuarioLogado = usuario;
		if (usuarioLogado != null) {
			// Exibir informações do usuário nos JLabels da tela Info
			LBrecebeNome.setText("Nome: " + usuarioLogado.getNome());
			LBrecebeCPF.setText("CPF: " + usuarioLogado.getCPF());
		...
		if (!jaAdicionado) {
			...
			if (quantidadeEstoque > 0) {
				Object[] produtoParaTabela = { produtoSelecionado[0], produtoSelecionado[1], produtoSelecionado[2], 1,
						produtoSelecionado[4] }; // Adicionando o preço do produto
	...
	public TelaVenda() {
		...
		BTNcontinuar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Info info = new Info(valorTotal, metodoPagamentoSelecionado, parcelasSelecionadas);
