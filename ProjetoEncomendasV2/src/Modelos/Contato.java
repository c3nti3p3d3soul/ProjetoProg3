...
public class Contato {
	...
	public boolean inserirContato(Connection conexao) {
	  ...
	  public static Contato buscarContatoPorUsuario(Connection conexao, int idUsuario) {
	        Contato contato = null;

	        String query = "SELECT * FROM Contato WHERE ID_USUARIO = ?";
	        try (PreparedStatement preparedStatement = conexao.prepareStatement(query)) {
	            ...
	            if (resultSet.next()) {
	                ...
	                contato.setBairro(resultSet.getString("BAIRRO"));
	                contato.setNumeroCasa(resultSet.getString("NUMERO_CASA"));
	                contato.setCep(resultSet.getString("CEP"));
	                contato.setCidade(resultSet.getString("CIDADE"));
	                contato.setUf(resultSet.getString("UF"));
	                contato.setDataNascimento(resultSet.getString("DATA_NASCIMENTO"));
	                
	                // Você pode adicionar outras instruções para atualizar os JLabels aqui
	            } else {
	                System.out.println("Nenhum contato encontrado para o usuário.");
	            }
