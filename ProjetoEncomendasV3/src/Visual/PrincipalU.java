...
public class PrincipalU extends JFrame {
	...
	public PrincipalU() {
		...
		LBcomprar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String senha = L.TFSenha.getText();
			        ...
			        Usuario usuarioLogado = Usuario.LogarUsuario(nomeUsuario, senha);
		...
		JLabel LBfecha = new JLabel("Fechar");
		LBfecha.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
		...
		LBfecha.setFont(new Font("Verdana", Font.BOLD, 20));
		LBfecha.setBounds(0, 0, 198, 50);
		panel_2_4.add(LBfecha);
